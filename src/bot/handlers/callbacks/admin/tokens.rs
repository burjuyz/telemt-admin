    ...
    match action {
        ...
        CallbackAction::PromptTokenCreate { auto_approve } => {
            let format_hint = format!(
                "Параметры invite-токена: срок действия ссылки (дни) и лимит активаций.\n\
                 Это не срок доступа пользователя в telemt.\n\n\
                 Формат: одно число (дни) или два числа: дни и максимум активаций.\n\
